...
app.get('/api/courses/:id',(req,res)=>{
    ...
    res.json(courses.find((ele)=>ele.id == req.params.id));//直接返回
});

app.get('/api/lessons/:id',(req,res)=>{
    console.log(req.params);
    res.json(lessons.find((ele)=>ele.id == req.params.id));//直接返回
});
app.get('/api/essays/:id',(req,res)=>{
    console.log(req.params);
    res.json(essays.find((ele)=>ele.id == req.params.id));//直接返回
});
